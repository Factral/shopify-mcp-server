...
export class ShopifyClient implements ShopifyClientPort {
  ...
  private myShopifyDomainCache: Record<string, string> = {};
  ...
  private async getMyShopifyDomain(
    ...
    // Sanitize shop name: strip protocol and trailing slashes
    ...
    if (this.myShopifyDomainCache[shop]) {
      return this.myShopifyDomainCache[shop];
    }
    ...
    // BREAK RECURSION: Use shopifyHTTPRequest directly instead of loadShop
    ...
    const myshopifyDomain = res.data.shop.myshopify_domain;
    this.myShopifyDomainCache[shop] = myshopifyDomain;
